                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-2">
                        ...
                        {isSelected && (
                          <span className="rounded bg-blue-100 px-2 py-0.5 text-sm text-blue-700 dark:bg-blue-900 dark:text-blue-300">
                      ...
                      {mode.prefix && (
                        <code className="mt-1 inline-block rounded bg-gray-100 px-1.5 py-0.5 text-sm dark:bg-gray-700">
                          {mode.prefix}
                        </code>
                      )}
                    </div>
