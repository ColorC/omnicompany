          ...
          <Confirmation key={request.requestId} approval="pending">
              ...
              <ConfirmationRequest>
                <div>
                  ...
                  <span className="ml-2 text-muted-foreground">
                    Tool: <code className="rounded bg-muted px-1.5 py-0.5 text-sm">{request.toolName}</code>
                  </span>
                </div>
                {permissionEntry && (
                  <div className="mt-1 text-sm text-muted-foreground">
                    Allow rule: <code className="rounded bg-muted px-1 py-0.5 text-sm">{permissionEntry}</code>
                  </div>
                )}
              </ConfirmationRequest>
            </ConfirmationTitle>
            ...
            {rawInput && (
              <details className="mt-2">
                ...
                <pre className="mt-2 max-h-40 overflow-auto whitespace-pre-wrap rounded-md border bg-muted/50 p-2 text-sm text-muted-foreground">
                  {rawInput}
                </pre>
              </details>
            )}
