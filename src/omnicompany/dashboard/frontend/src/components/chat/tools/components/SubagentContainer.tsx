  ...
  return (
    <div className="my-1 border-l-2 border-l-purple-500 py-0.5 pl-3 dark:border-l-purple-400">
      ...
      >
        ...
        {prompt && (
          <div className="mb-2 line-clamp-4 whitespace-pre-wrap break-words text-sm text-muted-foreground">
            {prompt}
          </div>
        )}
        ...
        {/* Completion status */}
        {isComplete && (
          <div className="mt-1 flex items-center gap-1.5 text-sm text-green-600 dark:text-green-400">
        ...
        {childTools.length > 0 && (
          <Collapsible className="mt-2">
            <CollapsibleTrigger className="flex items-center gap-1 text-[14px] text-muted-foreground hover:text-foreground">
              <svg
            ...
            <CollapsibleContent>
              <div className="mt-1 space-y-0.5 border-l border-border pl-3">
                {childTools.map((child, index) => (
                  <div key={child.toolId} className="flex items-center gap-1.5 text-[14px] text-muted-foreground">
          ...
          <div className="mt-2 text-sm text-muted-foreground">
            {(() => {
              ...
              return typeof content === 'string' ? (
                ...
                <pre className="line-clamp-6 whitespace-pre-wrap break-words font-mono text-[14px]">
