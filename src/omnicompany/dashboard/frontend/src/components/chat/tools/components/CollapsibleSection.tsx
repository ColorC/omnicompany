...
export const CollapsibleSection: React.FC<CollapsibleSectionProps> = ({
  ...
  return (
    <Collapsible defaultOpen={open} className={cn('group/section', className)}>
      ...
      {onTitleClick ? (
        <div className="flex cursor-default select-none items-center gap-1.5 py-0.5 text-sm group-data-[state=open]/section:sticky group-data-[state=open]/section:top-0 group-data-[state=open]/section:z-10 group-data-[state=open]/section:-mx-1 group-data-[state=open]/section:bg-background group-data-[state=open]/section:px-1">
          ...
          {toolName && (
            <span className="flex-shrink-0 text-[14px] text-muted-foreground/40">/</span>
          )}
          <button
