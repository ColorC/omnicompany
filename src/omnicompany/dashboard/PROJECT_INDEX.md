...
updated: 2026-06-12
roots:
  - path: /workspace/omnicompany/src/omnicompany/dashboard
    note: 主目录(后端 + 前端 + VSCode 扩展)
  - path: /workspace/omnicompany/docs/plans/dashboard
    note: 计划类目(权威进度文档都在这)
entry_points:
  - path: /workspace/omnicompany/src/omnicompany/dashboard/app.py
    note: dashboard 主进程入口(8210, FastAPI, 只装路由和静态资源)
  - path: /workspace/omnicompany/src/omnicompany/dashboard/boss_sight
    note: BOSS SIGHT 驾驶舱后端(项目工作板/计划/材料/子会话聚合)
  - path: /workspace/omnicompany/src/omnicompany/dashboard/ccdaemon
    note: 会话运行时独立进程(8201, 管 chat/pty 生命周期, 改代码不断会话)
  - path: /workspace/omnicompany/src/omnicompany/dashboard/controlplane
    note: 控制面路由/反向代理/版本总线(免重启更新的核心)
  - path: /workspace/omnicompany/src/omnicompany/dashboard/frontend
    note: React+Vite 前端, 构建产物挂到 static/
  - path: /workspace/omnicompany/src/omnicompany/dashboard/extensions/vscode-chat-sidebar
    note: VSCode 扩展, 在侧栏/标签页嵌入驾驶舱
  - path: /workspace/omnicompany/src/omnicompany/cli/commands/dashboard.py
