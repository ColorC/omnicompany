...
> [`docs/tech_debt/REGISTRY.md`](../../../../../../docs/tech_debt/REGISTRY.md) 共享数据源的 **I/O + 管理层**. 跟 guardian 分工 (生产者 vs 消费者): guardian 扫规则写 §活跃违规, tech_debt 读全 section + 管 resolve / list / stats. 加 DriftChecker 周期性产 §文档漂移条目.

---

## 这是什么

tech_debt 是 omnicompany 的 **REGISTRY.md 共享数据源 owner service**. 它读写 [`docs/tech_debt/REGISTRY.md`](../../../../../../docs/tech_debt/REGISTRY.md) (各 producer 写不同 section, 不交叉), 提供查询 + 解决 + 统计 + 漂移检查 + 主动登记五件事.
...
- 接入 [CORE-SELF-STABILITY 第二阶段](../../../../../../docs/plans/guardian/[2026-05-04]CORE-SELF-STABILITY/plan.md) 自我画像漂移检测 — DriftChecker 升级为画像-现实漂移监测的统一入口
...
- 数据源 → [docs/tech_debt/REGISTRY.md](../../../../../../docs/tech_debt/REGISTRY.md)
