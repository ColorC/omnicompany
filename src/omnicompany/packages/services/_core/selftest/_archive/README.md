...
- 新代码: `from omnicompany.packages.services.selftest.workers import RegistryCheckerWorker`
- 兼容路径: `from omnicompany.packages.services.selftest.routers import RegistryCheckerRouter` (旧名自动 alias 到新名)
