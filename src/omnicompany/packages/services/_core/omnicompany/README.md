...
> Worker / Material / Team 基类 + MaterialDispatcher (Worker × EventBus 激活引擎) + 金标范本库. **其他 agent 建新 Team 必参考的规范权威之一** (跟 self_creative_content_three_files.md / design_md_template.md 平级).
...
- **self_creative_content_three_files.md** 管 **文档层** README/DESIGN/SKILL 三件套规范
...
- 文档层三件套规范 → [docs/standards/protocol/self_creative_content_three_files.md](../../../../../../docs/standards/protocol/self_creative_content_three_files.md)
