...
<!-- [OMNI] origin=claude-code domain=docs/standards ts=2026-04-26T00:00:00Z type=standard status=active version=1 -->
<!-- [OMNI] material_id="material:standards.protocol.l2_session_summary_checklist.md" -->
...
- 主题目录按 omnicompany 8 大簇分: `voxelcraft / visual-pipeline / new-services / core-architecture / agent-routerization / arch-debt-and-naming / hypothesis-system / meta-self-publishing`
