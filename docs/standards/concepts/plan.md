...
| `[[material:domain.name]]` | 引用一份材料 | `[[material:gameplay_system.xlsm-formula-map]]` |
...
| `[[package:<type>/<name>]]` | 引用一个 package | `[[package:service/guardian]]` / `[[package:domain/gameplay_system]]` / `[[package:core/cli]]` |
